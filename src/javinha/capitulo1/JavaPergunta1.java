...
public class JavaPergunta1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Texto2.setText("O que é um algoritmo?");
        Texto2.setToolTipText("");

        Button1.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup1.add(Button1);
        Button1.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        Button1.setText("Uma sequência finita de instruções bem definidas e não ambiguas");

        Button2.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup1.add(Button2);
        Button2.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        Button2.setText("Uma sequência infinita de instruções bem definidas e não ambiguas");
        ...
        Button3.setText("Uma sequência finita de instruções mal definidas e ambiguas");
        ...
        Button4.setText("Uma sequência infinita de instruções mal definidas e não ambiguas");
