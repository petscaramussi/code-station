 ...
 * @author archwinlinu
 */
public class JavaPergunta2 extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public JavaPergunta2() {
        setUndecorated(true);
        initComponents();
        setSize(810, 580);
        ...
        setTitle("Inicio");
        setResizable(false);
        setDefaultCloseOperation(JavaPergunta2.EXIT_ON_CLOSE);
    }
    ...
    private void initComponents() {
        ...
        Button4.setText("Java 5.0 (versões 1.5 e posteriores)");
        ...
        Button5.setText("Java 10 (versão atual do Java)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JavaPergunta2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new JavaPergunta2().setVisible(true);
        });
    }
