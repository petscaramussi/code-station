 ...
 * @author archwinlinu
 */
public class JavaPergunta11 extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public JavaPergunta11() {
        setUndecorated(true);
        initComponents();
        setSize(810, 580);
        ...
        setTitle("Inicio");
        setResizable(false);
        setDefaultCloseOperation(JavaPergunta11.EXIT_ON_CLOSE);
    }
    ...
    private void initComponents() {
        ...
        Button4.setText("Valores falsos ou verdadeiros");
        ...
        Button5.setText("Qualquer tipo de caractere");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JavaPergunta11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new JavaPergunta11().setVisible(true);
        });
    }
