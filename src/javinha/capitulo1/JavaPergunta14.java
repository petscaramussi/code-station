 ...
 * @author archwinlinu
 */
public class JavaPergunta14 extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public JavaPergunta14() {
        setUndecorated(true);
        initComponents();
        setSize(810, 580);
        ...
        setTitle("Inicio");
        setResizable(false);
        setDefaultCloseOperation(JavaPergunta14.EXIT_ON_CLOSE);
    }
    ...
    private void initComponents() {
        ...
        Texto2.setText("Uma classe java pode possuir quantos métodos main?");
        ...
        Button5.setText("Quantas precisarem ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JavaPergunta14.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new JavaPergunta14().setVisible(true);
        });
    }
