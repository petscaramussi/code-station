 ...
 * @author archwinlinu
 */
public class JavaPergunta16 extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public JavaPergunta16() {
        setUndecorated(true);
        initComponents();
        setSize(810, 580);
        ...
        setTitle("Inicio");
        setResizable(false);
        setDefaultCloseOperation(JavaPergunta16.EXIT_ON_CLOSE);
    }
    ...
    private void initComponents() {
        ...
        Button4.setText("Compiladores da classes e objetos");
        ...
        Button5.setText("Lugares alocados na memoria para armazenar exclusivamente atributos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JavaPergunta16.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new JavaPergunta16().setVisible(true);
        });
    }
