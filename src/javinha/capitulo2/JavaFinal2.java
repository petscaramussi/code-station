 ...
 * @author archwinlinu
 */
public class JavaFinal2 extends javax.swing.JFrame {
    ...
    public JavaFinal2() {
        ...
        setTitle("Inicio");
        setResizable(false);
        setDefaultCloseOperation(JavaFinal2.EXIT_ON_CLOSE);
    }
    ...
    private void initComponents() {
        ...
        Texto4.setText("Você concluiu todos os exercícios do capítulo 2");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JavaFinal2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new JavaFinal2().setVisible(true);
        });
    }
