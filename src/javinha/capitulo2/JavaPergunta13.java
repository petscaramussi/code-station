 ...
 * @author archwinlinu
 */
public class JavaPergunta13 extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public JavaPergunta13() {
        setUndecorated(true);
        initComponents();
        setSize(810, 580);
        ...
        setTitle("Inicio");
        setResizable(false);
        setDefaultCloseOperation(JavaPergunta13.EXIT_ON_CLOSE);
    }
    ...
    private void initComponents() {
        ...
        Button2.setText("public class classe(){}");
        ...
        Button4.setText("public class classe{}");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JavaPergunta13.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new JavaPergunta13().setVisible(true);
        });
    }
