 ...
 * @author archwinlinu
 */
public class JavaPergunta10 extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public JavaPergunta10() {
        setUndecorated(true);
        initComponents();
        setSize(810, 580);
        ...
        setTitle("Inicio");
        setResizable(false);
        setDefaultCloseOperation(JavaPergunta10.EXIT_ON_CLOSE);
    }
    ...
    private void initComponents() {
        ...
        Texto2.setText("No Java, para criar uma classe cuja a definição é derivada");
        Texto2.setToolTipText("");

        Button1.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup1.add(Button1);
        Button1.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        Button1.setText("Extends");
        ...
        Texto3.setText("de outra classe é necessário utilizar a palavra reservada:");
        ...
        PanelTextoLayout.setHorizontalGroup(
            ...
            .addGroup(PanelTextoLayout.createSequentialGroup()
                .addGroup(PanelTextoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(Texto3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 530, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JavaPergunta10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new JavaPergunta10().setVisible(true);
        });
    }
