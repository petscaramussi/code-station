 ...
 * @author archwinlinu
 */
public class JavaPergunta12 extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public JavaPergunta12() {
        setUndecorated(true);
        initComponents();
        setSize(810, 580);
        ...
        setTitle("Inicio");
        setResizable(false);
        setDefaultCloseOperation(JavaPergunta12.EXIT_ON_CLOSE);
    }
    ...
    private void initComponents() {
        ...
        Button3.setText("public void metodo{}");
        ...
        Button4.setText("public void metodo()");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JavaPergunta12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new JavaPergunta12().setVisible(true);
        });
    }
