 ...
 * @author archwinlinu
 */
public class JavaPergunta17 extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public JavaPergunta17() {
        setUndecorated(true);
        initComponents();
        setSize(810, 580);
        ...
        setTitle("Inicio");
        setResizable(false);
        setDefaultCloseOperation(JavaPergunta17.EXIT_ON_CLOSE);
    }
    ...
    private void initComponents() {
        ...
        Texto2.setText("Qual desses não cria uma variável ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JavaPergunta17.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new JavaPergunta17().setVisible(true);
        });
    }
